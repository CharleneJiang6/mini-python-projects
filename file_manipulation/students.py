...
class Etudiant:
    ...
    def from_dict(dico_etu: dict) -> 'Etudiant':
        ...
        :param dico_etu: un dictionnaire représentant un étudiant de même format que celui produit par Etudiant
        """
...
def main():
    ...
    print("\n\nA présent, stockons ce groupe d'étudiant dans un fichier binaire nommé liste_etu.pkl")
    save_groupe_to_binary_file("liste_etu.pkl", groupe1)
    print("Chargeons ces données binaires")
    loaded_data = load_binary_file("liste_etu.pkl")
